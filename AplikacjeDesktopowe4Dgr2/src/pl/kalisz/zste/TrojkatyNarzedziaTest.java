...
class TrojkatyNarzedziaTest {
	...
	void testCzyTrojkatJestProstokatny() {
		...
		boolean prostokatny4 = TrojkatyNarzedzia.czyTrojkatJestProstokatny(4.5, 5.5, 7.106335201775948D);
		assertTrue(prostokatny4);
		boolean prostokatny5 = TrojkatyNarzedzia.czyTrojkatJestProstokatny(4.5, 5.5, 7.106335201775999D);
