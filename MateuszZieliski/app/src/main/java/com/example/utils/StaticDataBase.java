...
public class StaticDataBase {
    ...
    static {
        ...
        kawy.add(new Coffee(2, "Con panna", "Kawa con panna jest często podawana w eleganckich kawiarniach jako luksusowy napój. Bitą śmietaną dodaje się na wierzch kawy, co nadaje jej kremową konsystencję i delikatny smak. Kawa con panna jest doskonałą opcją dla miłośników kawy.", R.drawable.con_p));
