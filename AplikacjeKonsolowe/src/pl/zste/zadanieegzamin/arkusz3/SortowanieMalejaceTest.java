...
public class SortowanieMalejaceTest {
	...
	public void getIndexOfMax() {
		...
		Method method;
		try {
			method = sort.getDeclaredMethod("getIndexOfMax", tab.getClass(), int.class);
	...
	public void sortMyTable() {
		...
		sort.sortMyTable();
		assertEquals(10, sort.tablica[0]);
		assertEquals(7, sort.tablica[3]);
		assertEquals(1, sort.tablica[9]);
	}
